...
const HODODApprovals: React.FC<HODODApprovalsProps> = ({
  setView,
  odRequests,
  setOdRequests,
}) => {
      ...
      <div className="mb-10 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500 font-medium mt-1">
            Review and verify student OD requests for technical events.
          </p>
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
              ...
              {odRequests.map((request) => (
                ...
                >
                  ...
                  <td className="px-8 py-6">
                    ...
                    <span className="text-[10px] font-black text-blue-500 uppercase bg-blue-50 px-2 py-0.5 rounded-lg border border-blue-100">
                      Technical
                    </span>
                  </td>
                  <td className="px-8 py-6">
                  ...
                  <td className="px-8 py-6">
                    <div className="flex gap-2 justify-end opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        onClick={() => {
                          setOdRequests(
                            odRequests.filter((r) => r.id !== request.id)
                          );
          ...
          {odRequests.length === 0 && (
            <div className="py-20 text-center flex flex-col items-center">
              ...
              <p className="text-slate-500 text-sm">No pending OD requests.</p>
            </div>
          )}
        </div>
      </div>
