...
- **Automated Scraping:** Daily background jobs scrape upcoming fests from _KnowAFest_ and update the dashboard.
- **Student Dashboard:** Track attended events, earned certificates, and OD requests.
- **Admin/FA Panels:** Manage approvals and view analytics.
...
- `frontend/` - React application.
  ...
  - `components/` - React components (Student, Admin, FA views).
