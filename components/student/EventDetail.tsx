    ...
    <div className="absolute top-[80px] left-0 right-0 z-10 bg-white min-h-screen">
      <div className="animate-in fade-in duration-500 pb-20 bg-slate-50">
        <div className="w-full h-[400px] relative">
          ...
          <button
            onClick={onBack}
            className="absolute top-8 left-8 bg-white/20 backdrop-blur-xl border p-3 rounded-full text-white"
          >
          ...
          <div className="lg:col-span-1 bg-white p-8 rounded-[2.5rem] border shadow-2xl h-fit">
            ...
            {canRegister ? (
              <a
                ...
                target="_blank"
                className="block w-full py-4 bg-slate-900 text-white text-center rounded-2xl font-bold mb-4"
              >
                Register Now
              </a>
            ) : (
              <div className="block w-full py-4 px-4 bg-slate-100 text-slate-600 text-center rounded-2xl font-bold mb-4 leading-snug">
